...
#' \item{nqSup}{a scalar giving the length of the support grid of quantile
#'   functions based on which the \eqn{L^2} Wasserstein distance
...
DenFVar <- function(Ly = NULL, Lx = NULL, optns = list()) {
